...
final class VerifyPhoneNumberViewController: UIViewController, OTPDelegate {
...
extension VerifyPhoneNumberViewController {
  @objc private func didTapNext(_ sender: UIButton) {
    let registrationSuccessfulVC = RegistrationSuccessfulViewController()
    self.navigationController?.pushViewController(registrationSuccessfulVC, animated: true)
  }
}
